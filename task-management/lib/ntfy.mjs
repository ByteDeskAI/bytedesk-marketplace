...
export const CATALOG = {
  events: {
    ...
    "cap-ship": { group: "writes", label: "A capability is marked shipped", priority: "default", tags: "ship" },
    "cap-drop": { group: "writes", label: "A capability is dropped from the backlog", priority: "low", tags: "wastebasket" },
