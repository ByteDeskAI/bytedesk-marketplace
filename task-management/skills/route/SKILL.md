---
name: route
description: Pick which task-management flow fits — board, enhance, interview, map, spec, tickets, or implement — from live store state. Use when the user is unsure how to start.
user-invokable: true
