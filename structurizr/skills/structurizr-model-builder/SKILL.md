---
name: structurizr-model-builder
description: Author model elements: people, systems, groups.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr model builder.
