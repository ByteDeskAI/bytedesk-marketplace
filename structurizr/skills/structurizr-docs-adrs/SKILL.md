---
name: structurizr-docs-adrs
description: Attach documentation and ADRs.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr docs adrs.
