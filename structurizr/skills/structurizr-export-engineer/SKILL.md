---
name: structurizr-export-engineer
description: Export to PlantUML, Mermaid, DOT, JSON.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr export engineer.
