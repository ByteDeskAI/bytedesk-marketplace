---
name: structurizr-cli-operator
description: Structurizr CLI push/pull/lock/merge.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr cli operator.
