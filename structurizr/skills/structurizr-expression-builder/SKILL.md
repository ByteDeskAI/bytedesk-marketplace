---
name: structurizr-expression-builder
description: Build include/exclude and bulk expressions.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr expression builder.
...
# Structurizr Expression Builder
