---
name: structurizr-custom-elements
description: Custom elements outside C4.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr custom elements.
