---
name: structurizr-dynamic-view-author
description: Dynamic interaction/sequence views.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr dynamic view author.
...
# Structurizr Dynamic View Author
