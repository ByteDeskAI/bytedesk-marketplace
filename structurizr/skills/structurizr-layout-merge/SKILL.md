---
name: structurizr-layout-merge
description: Merge layout from JSON exports.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr layout merge.
