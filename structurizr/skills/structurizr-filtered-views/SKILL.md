---
name: structurizr-filtered-views
description: Stakeholder-specific filtered views.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr filtered views.
