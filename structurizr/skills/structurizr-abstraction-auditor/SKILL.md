---
name: structurizr-abstraction-auditor
description: Verify correct C4 abstraction level.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr abstraction auditor.
...
# Structurizr Abstraction Auditor
