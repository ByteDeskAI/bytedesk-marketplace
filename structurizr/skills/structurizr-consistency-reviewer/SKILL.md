---
name: structurizr-consistency-reviewer
description: Pre-PR model consistency review.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr consistency reviewer.
...
# Structurizr Consistency Reviewer
