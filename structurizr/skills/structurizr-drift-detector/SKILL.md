---
name: structurizr-drift-detector
description: Compare model against codebase reality.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr drift detector.
