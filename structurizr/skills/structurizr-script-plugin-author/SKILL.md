---
name: structurizr-script-plugin-author
description: Scripts and Java plugins.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr script plugin author.
...
# Structurizr Script Plugin Author
