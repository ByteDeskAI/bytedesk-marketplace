---
name: structurizr-dsl-language-reference
description: Deterministic DSL keyword lookup — never guess syntax.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr dsl language reference.
