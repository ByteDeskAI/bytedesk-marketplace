---
name: structurizr-diff-reviewer
description: Workspace diff for PR review.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr diff reviewer.
