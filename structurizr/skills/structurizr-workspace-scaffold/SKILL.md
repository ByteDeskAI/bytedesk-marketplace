---
name: structurizr-workspace-scaffold
description: Bootstrap workspace.dsl with enterprise layout.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr workspace scaffold.
...
# Structurizr Workspace Scaffold
