---
name: structurizr-cookbook-executor
description: Follow cookbook recipes step by step.
when_to_use: Use for Structurizr DSL and C4 modeling tasks involving structurizr cookbook executor.
