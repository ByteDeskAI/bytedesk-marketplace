...
Describe the product, user, and design job this profile serves.
...
Document any product-specific requirements beyond the shared WCAG 2.2 AA foundation.

## Exceptions to the shared foundation

List explicit exceptions with rationale, or state `None`.
